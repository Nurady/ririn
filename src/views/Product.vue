                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-text product-more">
                        <!-- <a href="./home.html"><i class="fa fa-home"></i> Home</a> -->
                         <!-- <router-link to="/product"><a href="./home.html"><i class="fa fa-home"></i> Home</a></router-link> -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :loop="true" :autoplay="true" :nav="false" :dots="false">
